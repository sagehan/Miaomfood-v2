...
<style lang="scss">
    ...
    :global {
        ...
        #VCARD::after, #TASTY::after, #DRINKS::after {
            content: "";
            position: absolute; inset: 0; block-size: 100%; inline-size: 100%;
            z-index: -1;
            opacity: 0;
            ...
            box-shadow:
                ...
                45px 45px 80px rgba(0, 0, 0, 0.07); //generated by https://shadows.brumm.af
        }
        #VCARD:hover::after,
        #TASTY:hover::after,
